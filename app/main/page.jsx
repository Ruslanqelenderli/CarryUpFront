...
import SendPagination from "../components/sendPagination";
import { SecondTooltip } from "../components/secondTooltip";
        ...
        >
          <div className=" bg-white  leftSection">
            ...
            <div className=" sticky bottom-0 flex ml-3 justify-between  bg-white pr-3 py-4">
              <button
                className="bg-transparent  font-semibold  px-6 py-1.5 border    rounded-md cancelButton "
                onClick={
              ...
              <button
                ...
                className={` ${activeButton == "forCarry" ? "bg-[#75B4FF]" : "bg-[#BFABDF]"
                  }  text-white  font-semibold  px-[28px] py-1.5 border    rounded-md `}
                onClick={() =>
                  activeButton === "forCarry"
                    ? getTrips(tripCurrentPage)
                    : getSends(sendCurrentPage)
